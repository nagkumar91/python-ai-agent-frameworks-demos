...
def _set_capture_env(provider: str, base_url: str) -> None:
    ...
    capture_defaults = {
        ...
        "OTEL_GENAI_AGENT_ID": os.getenv("OTEL_GENAI_AGENT_ID", "weather-chatbot"),
    }
...
def main() -> None:
    ...
    with tracer.start_as_current_span(
        ...
        span.set_attribute("tool.names", [t["function"]["name"] for t in tools])
        ...
        try:
            ...
            print(f"Response from {api_config.model_name} on {os.getenv('API_HOST', 'github')}:\n")
